...
<img width="275" alt="map-user" src="https://img.shields.io/badge/cloudformation template deployments-57-blue"> <img width="85" alt="map-user" src="https://img.shields.io/badge/views-416-green"> <img width="125" alt="map-user" src="https://img.shields.io/badge/unique visits-008-green">
...
SELECT * FROM SAMPLEDATA_ICEBERG_GDC LIMIT 10;
```
